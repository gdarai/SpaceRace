...
recipes.addShaped(<powersuits:powerArmorHead>.withTag({ench: [{id: 128 as short, lvl: 1 as short}]}), [[null, null, null], [airSeal, <powersuits:powerArmorHead>, airSeal], [null, null, null]]);
recipes.addShaped(<powersuits:powerArmorTorso>.withTag({ench: [{id: 128 as short, lvl: 1 as short}]}), [[null, null, null], [airSeal, <powersuits:powerArmorTorso>, airSeal], [null, null, null]]);
recipes.addShaped(<powersuits:powerArmorLegs>.withTag({ench: [{id: 128 as short, lvl: 1 as short}]}), [[null, null, null], [airSeal, <powersuits:powerArmorLegs>, airSeal], [null, null, null]]);
recipes.addShaped(<powersuits:powerArmorFeet>.withTag({ench: [{id: 128 as short, lvl: 1 as short}]}), [[null, null, null], [airSeal, <powersuits:powerArmorFeet>, airSeal], [null, null, null]]);
