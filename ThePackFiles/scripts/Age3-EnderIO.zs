...
recipes.addShaped(<enderio:blockSoulBinder>, [[plateYrdeen, <bqmie:icon_item:21>, plateYrdeen], [<ore:plateUranium>, <actuallyadditions:blockEmpowerer>, <ore:plateUranium>], [machineBlock, experienceCapsule, machineBlock]]);
