...
val bookCase = <bibliocraft:Bookcase:6>;
// Basic Recipes
...
mods.actuallyadditions.Empowerer.addRecipe(<minecraft:quartz>, si, <minecraft:dye:15>, <minecraft:dye:15>, <minecraft:dye:15>, <minecraft:dye:15>, 500, 20, 0, 0, 0.8);
...
recipes.addShaped(<refinedstorage:grid:1>, [[si, <actuallyadditions:itemCrystalEmpowered:4>, si], [<actuallyadditions:itemCrystalEmpowered:3>, <refinedstorage:grid>, <actuallyadditions:itemCrystalEmpowered:3>], [si, <opencomputers:upgrade:11>, si]]);
recipes.addShaped(<refinedstorage:disk_drive>, [[si, bookCase, si], [theIngot, bookCase, theIngot], [theBlock, gearTitIri, theBlock]]);
