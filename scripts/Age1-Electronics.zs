...
recipes.addShapeless(<forestry:beeswax>, [<ore:toolPot>, <ore:beeComb>]);
...
mods.tconstruct.Casting.addTableRecipe(ingotSteel, <liquid:iron> * 1296, coalCoke1, true, 3600);
mods.tconstruct.Casting.addTableRecipe(ingotSteel, <liquid:iron> * 1296, coalCoke2, true, 3600);
