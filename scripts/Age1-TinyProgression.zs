...
val diamondApple = <tp:diamond_apple>;
...
mods.actuallyadditions.Empowerer.addRecipe(<tp:growth_block>, <tp:growth_upgrade>, ingotDyonite, diamondApple, ingotDyonite, diamondApple, 100000, 200);
